...
module.exports = function (app) {
  ...
  app.post('/api/templates', function (req, res) {
    var attrs = {
      ...
      name: req.body.name,
      body: req.body.body,
      additionalCss: req.body.additionalCss
    };
    ...
    attrs = util.extend(attrs, format, true);
  ...
  app.put('/api/templates/:id', function (req, res) {
    var attrs = {
      ...
      name: helper.getIfInAttrs('name', req, res, 'template'),
      body: helper.getIfInAttrs('body', req, res, 'template'),
      additionalCss: helper.getIfInAttrs('additionalCss', req, res, 'template'),
