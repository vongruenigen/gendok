...
module.exports = function (app, config) {
  ...
  app.put('/api/profile/', function (req, res) {
    ...
    // In case a resetPasswordToken is set, we want to clear it because the
    // user probably signed in with this and we don't want the user to use it
    // again in the future!
    if (res.user.resetPasswordToken) {
      attrs.resetPasswordToken = '';
    }
