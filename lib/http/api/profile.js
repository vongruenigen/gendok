...
module.exports = function (app, config) {
  ...
  app.get('/api/profile/confirm', function (req, res) {
    if (!req.query.token) {
      res.status(errros.badRequest.code).send(errors.badRequest.data);
    } else {
  ...
  app.put('/api/profile/', function (req, res) {
    var attrs = {
      ...
      // TODO: When e-mail has been changed, an confirmation e-mail must be sent!!!
