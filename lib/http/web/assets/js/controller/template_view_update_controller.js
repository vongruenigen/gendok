...
;(function (root) {
  ...
  root.gendok.controller('templateViewUpdateController',
    ...
    $scope.openRenderingOptions = function () {
      $scope.renderingOptions = true;
    };

    $scope.render = function (template) {
      var payload = {
        payload: {
          customer_name: 'Papa Moll',
          customer_street: 'Globistrasse 10',
          customer_location: '1111 Mollhausen',
          customer_organisation: 'Pingu AG',
          components: [
            {
