  ...
  root.gendok.controller('templateController',
    ...
    $scope.updateFormatPreview = function () {
      ...
      templateService.calculateFormatPreviewValue(paperFormat, $scope.template.paperMarginUnit,
        $scope.template.paperMarginValue, function (value) {
      ...
      templateService.calculateFormatPreviewValue(paperFormat, $scope.template.headerHeightUnit,
        $scope.template.headerHeightValue, function (value) {
      ...
      templateService.calculateFormatPreviewValue(paperFormat, $scope.template.footerHeightUnit,
        $scope.template.footerHeightValue, function (value) {
    ...
    $scope.hightlightFormatAttribute = function (formatAttribute) {
      ...
      switch (formatAttribute) {
        case 'paperMargin':
          $scope.template.formatPreviewPaperMarginColor = 'rgba(108, 221, 171, 0.44)';
          console.log('ja');
          break;
        case 'headerHeight':
          $scope.template.formatPreviewHeaderHeightColor = 'rgba(108, 221, 171, 0.44)';
          break;
        case 'footerHeight':
          $scope.template.formatPreviewFooterHeightColor = 'rgba(108, 221, 171, 0.44)';
          break;
      }
    };
