...
HttpServer.prototype.start = function (fn) {
  ...
  this._queue  = util.createQueue(this._config);

  // Set the queue as a local on the app
  this._app.locals.queue = this._queue;
...
/**
 * Returns the associated queue object.
 *
 * @return {Queue} The queue object.
 */
HttpServer.prototype.getQueue = function () {
  return this._queue;
};
...
HttpServer.prototype.registerModule = function (fn) {
  ...
  fn(this.getApp(), this.getConfig(), this.getQueue());
};
