...
module.exports = function (db) {
  ...
  var options = {
    ...
    instanceMethods: {
      ...
      /**
       * This function can be used to determine if the current job is a batch
       * mode, which means multiple documents as result, or regular job. If the
       * job is a batch mode job true is returned, otherwise false.
       *
