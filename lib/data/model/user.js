...
module.exports = function (db) {
  ...
  var options = {
    ...
    hooks: {
      /**
       * In this afterUpdate hook we check if the email of the user has changed.
       * If so, we clear their apiToken, set a new confirmationToken and send a
       * confirmation email to allow the user confirm it's new email address.
       */
